...
function MyWorks({ carouselImages }) {
  return (
    <div className={s.myWorks}>
      <div className={s.myWorksBlockText}>
        <p>
          Я оказываю услуги по наращиванию ресничек на дому, в уютной атмосфере,
          с хорошей музыкой, ароматными маслами и вкусными напитками
        </p>
        <ul>
